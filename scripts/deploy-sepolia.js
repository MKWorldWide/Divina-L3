...
async function main() {
  console.log("🚀 Deploying GameDin L3 Contracts to Ethereum Sepolia Testnet...");
  ...
  console.log("📄 Deployment addresses saved to deployed-addresses-sepolia.json");
  
  // Print summary
  console.log("\n🎉 GameDin L3 Sepolia Deployment Complete!");
  console.log("=============================================");
