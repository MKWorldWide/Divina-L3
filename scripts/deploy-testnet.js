...
async function main() {
  console.log("🚀 Deploying GameDin L3 Contracts to Testnet...");
  ...
  // Save to file
  fs.writeFileSync('deployed-addresses-testnet.json', JSON.stringify(addresses, null, 2));
  
  console.log("📄 Deployment addresses saved to deployed-addresses-testnet.json");
  
  // Print summary
  console.log("\n🎉 GameDin L3 Testnet Deployment Complete!");
  console.log("=============================================");
