...
async function main() {
  console.log("🚀 Starting Core GameDin L3 Deployment...");
  ...
  try {
    ...
    // Step 2: Deploy NovaSanctumOracle
    ...
    // Print summary
    console.log("\n🎉 Core GameDin L3 Deployment Complete!");
    console.log("=========================================");
    ...
    console.log("\n🚀 Core GameDin L3 Gaming System is ready!");
    console.log("\n💡 Note: Bridge deployment can be done separately if needed.");
