...
import GamingCoreABI from '../contracts/abis/GamingCore.json';
import GDITokenABI from '../contracts/abis/GDIToken.json';
import AIOracleABI from '../contracts/abis/AIOracle.json';
